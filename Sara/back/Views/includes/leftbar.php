...
<li class="nav-item dropdown">
    ...
    <a class="dropdown-item" href="AfficherFournisseur.php">List  suppliers </a> 
	<a class="dropdown-item" href="connexion.php">Add suppliers</a>
...
<li class="nav-item dropdown">
    ...
    <div class="dropdown-menu" aria-labelledby="dropdown01">
    <a class="dropdown-item" href="afficherEvents.php">List events</a>
    <a class="dropdown-item" href="addEvent.php">Add event</a>    
						...
						<a href="download.php" class="dropdown-toggle no-arrow">
							<span class="micon dw dw-invoice"></span><span class="mtext">EXPORT EXCEL</span>
						</a>
					</li>
						...
						<a href="pdf.php" class="dropdown-toggle no-arrow">
							<span class="micon dw dw-invoice"></span><span class="mtext">EXPORT PDF</span>
						</a>
					</li>
</li>
</li>
