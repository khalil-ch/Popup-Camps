<?php
    ...
    if (isset($_POST['nom_E']) && isset($_POST['description_E']) && isset($_POST['image_E'])) {
        $event = new event($_POST['nom_E'], (float)$_POST['description_E'], $_POST['image_E']);
...
<body>
    ...
    <?php
        if (isset($_GET['idEvent'])) {
            $result = $eventC->getEventById($_GET['idEvent']);
			if ($result !== false) {
    ?>
		...
		<div class="form-container">
            <form action="" method = "POST">
                <div class="row">
                    ...
                    <div class="col-75">
                        <input type="text" name = "nom_E" value = "<?= $result['nom_E'] ?>">
                    </div>
                </div>
                <div class="row">
                    <div class="col-25">
                    ...
                    <div class="col-75">
                        <input type="text" name = "description_E" value = "<?= $result['description_E'] ?>">
                    </div>
                </div>
                <div class="row">
                    <div class="col-25">
                    ...
                    <div class="col-75">
                        <input type = "file" name = "image_E" value = "<?= $result['image_E'] ?>">
                    </div>
                </div>
                <br>
                <div class="row">
    ...
    <?php
            ...
            header('Location:afiicherEvent.php');
        }
