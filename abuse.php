...
class bbp_Report_Abuse {
	 ...
	 */
		...
		function_add_action( 'bbp_theme_before_reply_admin_links', array( $this, 'abuse_link_in_forum' ) );
		function_add_filter( 'gform_pre_render', array( $this, 'abuse_link_in_form' ) );
