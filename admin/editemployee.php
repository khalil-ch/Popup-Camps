...
<body>
<?php
		$sql = "SELECT * from employees where idem = :editid";
		$query = $dbh -> prepare($sql);
	...
	<?php include('includes/leftbar.php');?>
		<div class="content-wrapper">
			<div class="container-fluid">
				<div class="row">
					<div class="col-md-12">
						<h3 class="page-title">Edit Employee : <?php echo htmlentities($result->name); ?></h3>
						<div class="row">
							<div class="col-md-12">
...
<div class="col-sm-4">
<input type="number" name="mobileno" class="form-control" required value="<?php echo htmlentities($result->mobileno);?>">
</div>
</div>
...
<div class="form-group">
	<div class="col-sm-8 col-sm-offset-2">
		...
		<input type="hidden" name="idedit" value="<?php echo htmlentities($result->idem);?>" >
</div>
</div>
