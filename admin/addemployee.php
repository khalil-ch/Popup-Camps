					...
					<div class="col-md-9">
						...
						<div class="well row pt-2x pb-3x bk-light text-center">
                         <form  method="post" class="form-horizontal" enctype="multipart/form-data" name="regform" onSubmit="return validate();">
                            ...
                            <div class="col-sm-5">
                            <input type="text" id='idem' name="idem" class="form-control" required>
                            </div>
                            ...
                            <div class="col-sm-5">
                            <input type="text" id='idmanager' name="idmanager" class="form-control" required >
                            </div>
...
nation<span style="color:red">*</span></label>
	...
	<!-- Loading Scripts -->
	<script src="controleemployee.js"></script>
