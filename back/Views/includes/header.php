...
<head>
	...
	<link rel="icon" type="deskapp2-master/image/png" sizes="32x32" href="deskapp2-master/vendors/images/favicon-32x32.png">
	<link rel="icon" type="deskapp2-master/image/png" sizes="16x16" href="deskapp2-master/vendors/images/favicon-16x16.png">
...
<div class="dropdown-menu dropdown-menu-right">
						<div class="notification-list mx-h-350 customscroll">
							<ul>
								<li>
									<a href="#">
										<img src="deskapp2-master/vendors/images/img.jpg" alt="">
										<h3>John Doe</h3>
								...
								<li>
									<a href="#">
										<img src="deskapp2-master/vendors/images/photo1.jpg" alt="">
										<h3>Lea R. Frith</h3>
										<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed...</p>
									</a>
								</li>
								<li>
									<a href="#">
										<img src="deskapp2-master/vendors/images/photo2.jpg" alt="">
								...
								<li>
									<a href="#">
										<img src="deskapp2-master/vendors/images/photo3.jpg" alt="">
										<h3>John Doe</h3>
										<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed...</p>
									</a>
								</li>
								<li>
									<a href="#">
										<img src="deskapp2-master/vendors/images/photo4.jpg" alt="">
				...
				<div class="dropdown">
					<a class="dropdown-toggle" href="#" role="button" data-toggle="dropdown">
						<span class="user-icon">
							<img src="deskapp2-master/vendors/images/user.jpg" alt="">
						</span>
						<span class="user-name">Admin</span>
					</a>
					<div class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list">
						<a class="dropdown-item" href="../../admin/profile.php"><i class="dw dw-user1"></i> Profile</a>
						<a class="dropdown-item" href="../../admin/change-password.php"><i class="dw dw-user1"></i> change password</a>
