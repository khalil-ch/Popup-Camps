                ...
                <div class="col-9  text-right">
                    ...
                    <nav class="site-navigation text-right ml-auto d-none d-lg-block" role="navigation">
                        <ul class="site-menu main-menu js-clone-nav ml-auto ">
                            ...
                            <li class="active"><a href="about.php" class="nav-link">About The Offers</a></li>
...
<script src="js/main.js"></script>
    ...
    <div class="site-section bg-image overlay" style="background-image: url('images1/hero_1.jpg')">
      <div class="container">
            ...
            <p class="text-white"> Don't Miss Out on our exlusive Offers made just for you!</p>
            <p class="mb-0"><a href="offertab.php" class="btn btn-primary text-white py-3 px-4">Explore</a></p>
          </div>
        </div>
      </div>
    </div>
