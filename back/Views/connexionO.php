  ...
  <form  method="post" class="form-horizontal" enctype="multipart/form-data" name="regform" onSubmit="return validate();">
    ...
    <table border="1" align="center">
        ...
        <tr>
            ...
            <td><input type="number" name="id_offer" id ="id_offer" maxlength="20" class="form-control" required></td>
        </tr>
        <tr>
            <td>
            ...
            <td>
                <input type="text" name="nom_offer" id ="nom_offer" maxlength="30" class="form-control" required>
            </td>
        </tr>
        <tr>
            <td>
            ...
            <td>
                <select name="type_offer" id="type_offer">
                    ...
                    <option value="Animals Day">Animals Day</option>
        ...
        <tr>
            ...
            <td>
                <input type="date" id ="date_offer" name="date_offer"
        ...
        <tr>
            ...
            <td>
                <input type="number" name="duree_offer" id ="duree_offer" maxlength="30" class="form-control" required>
            </td>
        </tr>
