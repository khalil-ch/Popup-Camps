 ...
 <form  method="post" class="form-horizontal" enctype="multipart/form-data" name="regform" onSubmit="return validate();">
      ...
      <table border="1" align="center">
        ...
        <tr>
            ...
            <td>
                <input type="text" name="nom_promo" id="nom_promo" maxlength="30" class="form-control" required>
            </td>
        </tr>
        <tr>
            <td>
        ...
        <tr>
            ...
            <td>
                <input type="number" name="duree_promo" id="duree_promo" maxlength="30" class="form-control" required>
            </td>
        </tr>
