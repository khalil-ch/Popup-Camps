 				...
 				<ul id="accordion-menu">
 					...
 					<li class="nav-item dropdown">
 						...
 						<div class="dropdown-menu" aria-labelledby="dropdown01">
 							<a class="dropdown-item" href="/popupcampIntegrated/popupcamp/admin/userlist.php">Users
 								list</a>
 							<a class="dropdown-item"
 								href="/popupcampIntegrated/popupcamp/admin/deleteduser.php">deleted users</a>
 							<a class="dropdown-item"
 								href="/popupcampIntegrated/popupcamp/admin/feedback.php">Feedback</a>
 					...
 					<li class="nav-item dropdown">
 						...
 						<div class="dropdown-menu" aria-labelledby="dropdown01">
 							<a class="dropdown-item"
 								href="/popupcampIntegrated/popupcamp/admin/employeelist.php">employees list</a>
 							<a class="dropdown-item" href="/popupcampIntegrated/popupcamp/admin/addemployee.php">Add
 								employees</a>
 							<a class="dropdown-item"
 								href="/popupcampIntegrated/popupcamp/admin/adminemployees.php">Employees run by me</a>
 					...
 					<li class="nav-item dropdown">
 						...
 						<div class="dropdown-menu" aria-labelledby="dropdown01">
 							<a class="dropdown-item" href="/popupcampIntegrated/popupcamp/admin/download.php">excel
 								list </a>
 							<a class="dropdown-item" href="/popupcampIntegrated/popupcamp/admin/pdf.php">pdf list</a>
 							<a class="dropdown-item"
 								href="/popupcampIntegrated/popupcamp/admin/downloademployees.php">Employees excel list
 							</a>
 					...
 					<li class="nav-item dropdown">
 						...
 						<div class="dropdown-menu" aria-labelledby="dropdown01">
 							<a class="dropdown-item" href="/popupcampIntegrated/popupcamp/admin/pie.php">gender
 								repartition </a>
 							<a class="dropdown-item"
 								href="/popupcampIntegrated/popupcamp/admin/barchart.php">designation per gender</a>
					 ...
					 <li class="nav-item dropdown">
 						<a class="nav-link dropdown-toggle" href="#" id="dropdown02" data-toggle="dropdown"
 							aria-haspopup="true" aria-expanded="false">Campgrounds</a>
 						<div class="dropdown-menu" aria-labelledby="dropdown01">
 							<a class="dropdown-item"
					 ...
					 <li class="nav-item dropdown">
 						<a class="nav-link dropdown-toggle" href="#" id="dropdown02" data-toggle="dropdown"
 							aria-haspopup="true" aria-expanded="false">Statistics</a>
 						<div class="dropdown-menu" aria-labelledby="dropdown01">
 							<a class="dropdown-item"
