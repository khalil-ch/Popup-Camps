		...
		<div class="menu-block customscroll">
			...
			<li class="dropdown">
						...
						<ul class="submenu">
							...
							<li><a href="editProduct.php">Editer un produit</a></li>
							<li><a href="editCategorie.php">Editer une categorie</a></li>
						</ul>
							<li class="dropdown">
						<a href="javascript:;" class="dropdown-toggle">
						...
						<ul class="submenu">
							...
							<li><a href="afficherCommandes.html">Afficher Commandes</a></li>
							<li><a href="ajouterCommande.php">Ajouter une commande</a></li>
							<li><a href="moidifierCommande.html">Modifier une commande</a></li>
						</ul>
                        ...
                        <tbody>
                            ...
                            <form action="" method="post">
                                <tr>
                                                ...
                                                <td><a class="btn btn-success" href="afficherCommandes.php" >Return</a></td>
                                            </tr>
