...
<html lang="en">
 ...
 <li><a href="front/view/tabpromo.php" class="nav-link">promotions</a></li>
    ...
    <div class="ftco-blocks-cover-1">
      <div class="site-section-cover overlay" style="background-image: url('trips/trips/images/hero_1.jpg')">
        <div class="container">
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-lg-4 col-md-6 mb-4" data-aos="fade-up">
            <div class="listing-item">
              <div class="listing-image">
                <img src="trips/trips/images/img_1.jpg" alt="Image" class="img-fluid">
              </div>
          ...
          <div class="col-lg-4 col-md-6 mb-4" data-aos="fade-up">
            <div class="listing-item">
              <div class="listing-image">
                <img src="trips/trips/images/img_2.jpg" alt="Image" class="img-fluid">
              </div>
              <div class="listing-item-content">
          ...
          <div class="col-lg-4 col-md-6 mb-4" data-aos="fade-up">
            <div class="listing-item">
              <div class="listing-image">
                <img src="trips/trips/images/img_3.jpg" alt="Image" class="img-fluid">
              </div>
              <div class="listing-item-content">
          ...
          <div class="col-lg-4 col-md-6 mb-4" data-aos="fade-up">
            <div class="listing-item">
              <div class="listing-image">
                <img src="trips/trips/images/img_4.jpg" alt="Image" class="img-fluid">
              </div>
              <div class="listing-item-content">
          ...
          <div class="col-lg-4 col-md-6 mb-4" data-aos="fade-up">
            <div class="listing-item">
              <div class="listing-image">
                <img src="trips/trips/images/img_5.jpg" alt="Image" class="img-fluid">
              </div>
              <div class="listing-item-content">
          ...
          <div class="col-lg-4 col-md-6 mb-4" data-aos="fade-up">
            <div class="listing-item">
              <div class="listing-image">
                <img src="trips/trips/images/img_6.jpg" alt="Image" class="img-fluid">
              </div>
              <div class="listing-item-content">
        ...
        <div class="row">
          ...
          <div class="col-lg-4 col-md-6 mb-4">
            <div class="person-29191 text-center">
              <img src="trips/trips/images/person_1.jpg" alt="Image" class="img-fluid mb-4">
              <div class="px-4">
          ...
          <div class="col-lg-4 col-md-6 mb-4">
            <div class="person-29191 text-center">
              <img src="trips/trips/images/person_2.jpg" alt="Image" class="img-fluid mb-4">
              <div class="px-4">
          ...
          <div class="col-lg-4 col-md-6 mb-4">
            <div class="person-29191 text-center">
              <img src="trips/trips/images/person_3.jpg" alt="Image" class="img-fluid mb-4">
              <div class="px-4">
          ...
          <div class="row">
            <div class="col-md-6">
              ...
              <div class="testimonial-39191 d-flex">
                ...
                <div>
                <blockquote>&ldquo;i found the best campground here!?&rdquo;</blockquote>
                <p>&mdash; John Doe</p>
                </div>
              </div>    
        ...
        <div class="row">
          <div class="col-lg-4 col-md-6 mb-4">
            <div class="post-entry-1 h-100">
              <a href="single.html">
                <img src="trips/trips/images/img_1.jpg" alt="Image"
                 class="img-fluid">
              </a>
          ...
          <div class="col-lg-4 col-md-6 mb-4">
            <div class="post-entry-1 h-100">
              <a href="single.html">
                <img src="trips/trips/images/img_2.jpg" alt="Image"
                 class="img-fluid">
              </a>
              <div class="post-entry-1-contents">
          ...
          <div class="col-lg-4 col-md-6 mb-4">
            <div class="post-entry-1 h-100">
              <a href="single.html">
                <img src="trips/trips/images/img_3.jpg" alt="Image"
                 class="img-fluid">
              </a>
              <div class="post-entry-1-contents">
    ...
    <div class="site-section bg-image overlay" style="background-image: url('trips/trips/images/hero_1.jpg')">
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-md-7 text-center">
            <h2 class="font-weight-bold text-white">Join and Trip With Us</h2>
            <p class="text-white">join us for limitless fun</p>
          ...
          <div class="col-lg-3">
            ...
            <div class="row">
              <div class="col-4 gal_col">
                <a href="#"><img src="trips/trips/images/insta_1.jpg" alt="Image" class="img-fluid"></a>
              </div>
              <div class="col-4 gal_col">
                <a href="#"><img src="trips/trips/images/insta_2.jpg" alt="Image" class="img-fluid"></a>
              </div>
              <div class="col-4 gal_col">
                <a href="#"><img src="trips/trips/images/insta_3.jpg" alt="Image" class="img-fluid"></a>
              </div>
              <div class="col-4 gal_col">
                <a href="#"><img src="trips/trips/images/insta_4.jpg" alt="Image" class="img-fluid"></a>
              </div>
              <div class="col-4 gal_col">
                <a href="#"><img src="trips/trips/images/insta_5.jpg" alt="Image" class="img-fluid"></a>
              </div>
              <div class="col-4 gal_col">
                <a href="#"><img src="trips/trips/images/insta_6.jpg" alt="Image" class="img-fluid"></a>
              </div>
            </div>
          </div>
